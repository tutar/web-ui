...
import { ArrowLeft, Folder, FileText, ChevronRight, ChevronDown, Edit2, Check, AlertCircle } from 'lucide-react';
    ...
    children: [
      {
        ...
        type: 'folder',
        children: [
          { id: '2', name: 'main.py', type: 'file', content: 'def main():\n    print("Hello world")\n\nif __name__ == "__main__":\n    main()' },
      ...
      { id: '5', name: 'SKILL.md', type: 'file', content: '---\nname: My Skill\ndescription: This is a sample skill.\n---\n\n# My Skill\n\nThis is a sample skill.' },
    ]
  }
];

function FileTreeView({ nodes, level = 0, onSelectFile, selectedFileId }: { nodes: FileNode[], level?: number, onSelectFile: (node: FileNode) => void, selectedFileId: string | null }) {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 group">
            {isEditingName ? (
              ...
              <>
                <h1 className="text-sm font-bold uppercase tracking-widest text-theme-accent cursor-pointer" onDoubleClick={() => setIsEditingName(true)}>{skillName}</h1>
                <button 
              ...
              <div className="flex-1 px-6 pb-6 overflow-hidden flex flex-col">
                {isEditMode ? (
                  ...
                  <div className="flex-1 w-full bg-theme-surface border border-theme-border rounded p-4 overflow-auto shadow-inner">
                    <pre className="text-theme-text font-mono text-sm leading-relaxed">
                      {fileContent}
                    </pre>
                  </div>
                )}
