    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-theme-surface-hover border border-theme-border rounded-xl w-full max-w-md shadow-2xl overflow-hidden text-theme-text">
        <div className="px-6 py-4 border-b border-theme-border flex justify-between items-center">
          ...
          <button onClick={onClose} className="text-theme-text-secondary hover:text-theme-text transition-colors rounded p-1 hover:bg-theme-surface-active">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6">
          <div className="flex gap-2">
            ...
            >
              ...
              <span className="text-[11px] uppercase tracking-widest font-medium">{t('manage.importFromGithub')}</span>
            </button>
            <button
            ...
            >
              ...
              <span className="text-[11px] uppercase tracking-widest font-medium">{t('manage.uploadFolder')}</span>
            </button>
          </div>
