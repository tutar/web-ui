...
import { Plus, Search, MoreVertical, ArrowUpDown, Check } from "lucide-react";
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-theme-base">
      <div className="h-16 border-b border-theme-border flex items-center justify-between px-6 bg-theme-surface">
        <h1 className="text-sm font-bold uppercase tracking-widest text-theme-text">
          ...
          <div className="relative">
            ...
            {isSortOpen && (
              <div className="absolute top-full mt-1 right-0 bg-theme-surface border border-theme-border rounded-lg shadow-xl py-1 z-20 w-48 text-theme-text">
                ...
                {["Recent activity", "Last edited", "Date created"].map(
                  (option) => (
                    <button
                      key={option}
                      onClick={() => {
          ...
          {filteredProjects.map((project) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                <h3 className="font-semibold text-lg text-theme-text">
                  {project.name}
                </h3>
                <button
              ...
              <p className="text-theme-text-secondary text-sm mb-4 flex-1">
                {project.description}
              </p>
